...
public class ViewCustomerSystem {
	...
	//move to internet banking
		...
		//click on register
		 ...
		 //click on delete customer
			...
			//enter the details
			driver.findElement(By.name("Cust_ac_no")).sendKeys(str1);
			driver.findElement(By.name("Cust_ac_Id")).sendKeys(st4);
			driver.findElement(By.name("reason")).sendKeys("fake");
